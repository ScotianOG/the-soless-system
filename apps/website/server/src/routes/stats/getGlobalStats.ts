// src/routes/stats/getGlobalStats.ts
...
export async function getGlobalStats(
  ...
  // Get total point transaction count (all-time) - represents total point-earning events
  const totalEngagements = await prisma.pointTransaction.count();
