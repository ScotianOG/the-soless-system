...
describe("Verification System Tests", () => {
  ...
  describe("Code Generation", () => {
    ...
    it("should store verification code in database", async () => {
      ...
      expect(storedCode?.platform).toBe(Platform.TELEGRAM);
    });
  ...
  describe("Code Verification", () => {
    ...
    beforeEach(async () => {
      testCode = await verificationService.generateCode(
        TEST_USER_ID,
        Platform.TELEGRAM
      );
    });
    ...
    it("should prevent duplicate platform accounts", async () => {
      ...
      const secondCode = await verificationService.generateCode(
        TEST_USER_ID,
        Platform.TELEGRAM
      );
      await expect(
      ...
      ).rejects.toThrow("TELEGRAM account already linked to another user");
    });
  });
