...
async function inspectContestData() {
  try {
    ...
    const totalRecords = contests.length + contestEntries + contestRewards + contestQualifications + contestPointTransactions;
    ...
    console.log(`   • Total Current Points: ${totalUserPoints._sum.points || 0}`);
    console.log(`   • Total Lifetime Points: ${totalUserPoints._sum.lifetimePoints || 0}`);
